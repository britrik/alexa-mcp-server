...
export const EnvSchema = z.object({
	/** Amazon ubid-main cookie value (new secret name) */
	UBIDMAIN: z.string().optional(),

	/** Amazon at-main authentication token (new secret name) */
	ATMAIN: z.string().optional(),

	/** Legacy Amazon ubid-main cookie value */
	UBID_MAIN: z.string().optional(),

	/** Legacy Amazon at-main authentication token */
	...
	/** Alexa marketplace ID for GraphQL requests (new secret name) */
	ALEXAMARKETPLACEID: z.string().min(1).optional(),

	/** Legacy Alexa marketplace ID for GraphQL requests */
	ALEXA_MARKETPLACE_ID: z.string().min(1).optional(),
	...
	/** ElevenLabs API key binding */
	ELEVENLABSAPIKEY: z.string().optional(),

	/** Default ElevenLabs voice ID binding */
